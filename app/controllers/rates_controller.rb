class RatesController < ApplicationController
  ...
  private
    ...
    def rate_params
      params.require(:rate).permit(:user_id,
                                   :contract_id,
                                   :lane_calc, :from_loccode, :from_city, :from_state, :from_zip, :from_country,
                                   :to_loccode, :to_city, :to_state, :to_zip, :to_country, :scac, :service,
